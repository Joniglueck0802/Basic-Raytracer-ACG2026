...
This is my **Test Ray Tracer** project. It is used to understand, implement, and test the contents of the course *Advanced User Interfaces* at the Hochschule Bonn-Rhein-Sieg (HBRS).

## Overview

The project is based on the book series and reference implementation by Peter Shirley:
